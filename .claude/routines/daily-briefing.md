...
4. **禁止把某人的"一贯观点"合成为"一篇新文章"**。事故记录：2026-07-11 曾把 Gary Marcus 六月观点脑补成"7月9日新文"（当日他并无发文）、虚构 Dwarkesh×Amodei 访谈与 Willison 文章，被逐源核验揭穿。发布前自检：每条 Tier 0 的链接能否在本次抓取记录里找到？找不到就删。
